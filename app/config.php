...
$projectArr = require_once APP_PATH . 'project.php'; // 加载独立配置文件
$configArr = [
    // +----------------------------------------------------------------------
    // | 应用设置
    // +----------------------------------------------------------------------
    ...
    'root_namespace'         => [],
    // 扩展函数文件
    'extra_file_list'        => [THINK_PATH . 'helper' . EXT, APP_PATH . 'home/my_func' . EXT],
    // 默认输出类型
    ...
    'email_config' => [
        ...
        'smtp_host_name'  => 'www.withsawyer.cn',       // 设置发件人的主机域 可有可无 默认为localhost 内容任意，建议使用你的域名
        'smtp_ssl'        => 'ssl',                     // SMTP使用ssl加密方式登录鉴权
...
return array_merge($projectArr, $configArr);